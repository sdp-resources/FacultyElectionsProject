...
public class InMemoryGatewayFromFileTest {
  ...
  @Before
  public void setUp() {
    InputStream resourceAsStream = new AssetLoader().resourceAt("/data/sample.json");
    gateway = InMemoryGateway.fromJSONFile(resourceAsStream);
  }
